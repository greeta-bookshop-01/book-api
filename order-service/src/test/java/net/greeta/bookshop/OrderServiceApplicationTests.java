...
import net.greeta.bookshop.book.Book;
import net.greeta.bookshop.book.BookClient;
import net.greeta.bookshop.order.domain.Order;
import net.greeta.bookshop.order.domain.OrderStatus;
import net.greeta.bookshop.order.event.OrderAcceptedMessage;
import net.greeta.bookshop.order.web.OrderRequest;
...
class OrderServiceApplicationTests {
	...
	static void generateAccessTokens() {
		WebClient webClient = WebClient.builder()
				.baseUrl(keycloakContainer.getAuthServerUrl() + "realms/book-realm/protocol/openid-connect/token")
